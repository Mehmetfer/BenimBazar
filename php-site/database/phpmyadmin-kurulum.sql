-- CHANGE X — phpMyAdmin Import (u2759108_changex)
-- cPanel → phpMyAdmin → u2759108_changex seç → Import → bu dosyayı yükle → Go
...
-- superadmin: kurulum.php ile olusturun veya scripts/gen_superadmin_sql.php kullanin
